...
public static class RequestUtilities
{
    ...
    public static bool ShouldSkipResponseHeader(string headerName)
    {
    ...
    public static bool IsValidPathChar(char c) => s_validPathChars.Contains(c);
    ...
    public static void AddHeader(HttpRequestMessage request, string headerName, StringValues value)
    {
        if (value.Count == 1)
        {
    ...
    public static void RemoveHeader(HttpRequestMessage request, string headerName)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryGetValues(HttpHeaders headers, string headerName, out StringValues values)
    {
    ...
    public static bool IsResponseSet(HttpResponse response)
    {
